...
Original file is located at
    https://colab.research.google.com/drive/1LhKZZ6uKial1xhdO8t1BdFhEyJmA7Kn0
"""

# ✅ Updated model.py for VQ-VAE + Transformer Inference (Hugging Face / GitHub Ready)
...
class VQEncoder(nn.Module):
    def __init__(self, in_channels=3, hidden_dim=512):
        ...
        self.encoder = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Conv2d(256, hidden_dim, 4, 2, 1),
            nn.ReLU(),
        )
...
def generate_image_from_text(vqvae, transformer, text_embed, seq_len=196, p=0.9, temperature=1.0):
    ...
    for _ in range(seq_len):
        ...
        x = torch.cat([x, transformer.token_embedding(next_token.squeeze(1)).unsqueeze(1)], dim=1)
...
if __name__ == "__main__":
    ...
    # Generate & show image
    img = generate_image_from_text(vqvae, transformer, text_embed)[0].permute(1, 2, 0).cpu().numpy()
    img = (img + 1) / 2
    plt.imshow(img)
    plt.axis("off")
